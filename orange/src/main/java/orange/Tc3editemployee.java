...
public class Tc3editemployee {

	@Test
	public static void HRM(String[] args)throws Exception {
	  ...
	  WebElement searchby=x.findElement(By.id("loc_code"));
	    ...
	    search.click();
	    Thread.sleep(2000);
	    /*int row=x.findElements(By.xpath("//*[@id='standardView']/table/tbody/tr[3]")).size();
	    String sEMPID=x.findElement(By.xpath("//*[@id='standardView']/table/tbody/tr[3]/td[2]")).getText();
	    String sEMPNAME=x.findElement(By.xpath("//*[@id='standardView']/table/tbody/tr[3]/td[3]/a")).getText();*/
	    WebElement clickname=x.findElement(By.xpath("//*[@id='standardView']/table/tbody/tr/td[3]/a"));
	    x.findElement(By.xpath("//*[@id='standardView']/table/tbody/tr/td[3]/a"));
	    clickname.click();
	    Thread.sleep(2000);
	    WebElement edit=x.findElement(By.xpath("//*[@id='btnEditPers']"));
	    x.findElement(By.xpath("//*[@id='btnEditPers']"));
	    edit.click();
	    Thread.sleep(2000);
	  String smiddlename="yeachni";
	    WebElement middlename=x.findElement(By.id("txtEmpMiddleName"));
	    x.findElement(By.id("txtEmpMiddleName")).sendKeys(smiddlename);
	    Thread.sleep(2000);
	  WebElement esave=x.findElement(By.xpath("//*[@id='btnEditPers']"));
	  x.findElement(By.xpath("//*[@id='btnEditPers']")).click();
	    Thread.sleep(2000);
	    WebElement eback=x.findElement(By.className("backbutton"));
	    x.findElement(By.className("backbutton"));
	    eback.click();
	    Thread.sleep(2000);
	    WebElement esearchby=x.findElement(By.id("loc_code"));
	    x.findElement(By.id("loc_code"));
	    searchby.click();
	    Thread.sleep(2000);
	    Select esel=new Select(searchby);
	    sel.selectByVisibleText("Emp. ID");
	    Thread.sleep(2000);
	    WebElement esearchfor=x.findElement(By.id("loc_name"));
	    x.findElement(By.id("loc_name"));
	    searchfor.sendKeys(sEmpCode);
	    Thread.sleep(2000);
	    WebElement esearch=x.findElement(By.className("plainbtn"));
	    x.findElement(By.className("plainbtn"));
	    search.click();
	    Thread.sleep(2000);
